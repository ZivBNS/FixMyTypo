...
It runs silently in the background and can be triggered with a simple **double‑Caps Lock hotkey**.

## ✨ Features

- 🔄 Convert text between Hebrew and English keyboard layouts
- ⌨️ Trigger conversion with a **double Caps Lock** key press
...
Double-tap Ctrl → the text will be replaced with the corrected version.
